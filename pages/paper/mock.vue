              ...
              <v-col style="padding: 0" cols="10">
                <v-table>
                  ...
                  <tr style="height: 30px">
                    ...
                    <td colspan="2">fdsafsfasfasf</td>
                  </tr>
                  <tr style="height: 30px">
                    <td colspan="2"><b>ที่อยู่: </b></td>
                    <td colspan="2">fasdfasfasdfasd</td>
                  </tr>
                  <tr style="height: 30px">
                    <td colspan="2">
                      <b>สาขา: </b>
                    </td>
                    <td colspan="2">sadfasfsadfsda</td>
                  </tr>
                  <tr style="height: 20px">
                    <td colspan="2" style="font-weight: bold">&nbsp;</td>
                  </tr>
          ...
          <v-col>
            <v-table style="font-size: 12px">
              ...
              <tr>
                ...
                <td style="text-align: center">20/05/2566</td>
              </tr>
              <tr>
                <td><b>เลขที่ใบเสร็จรับเงิน:</b></td>
                <td style="text-align: center">2001554</td>
              </tr>
            </v-table>
          </v-col>
        </v-row>
